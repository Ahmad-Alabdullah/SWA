...
| datasource.url | string | `"jdbc:postgresql://localhost/zulieferer"` |  |
| datasource.username | string | `"zulieferer"` |  |
...
| image.name | string | `"zulieferer"` | Name des Image |
...
| logLevel.application | string | `"info"` | Loglevel für zulieferer als Umgebungsvariable |
